...
class CellTypeModel:
    ...
    def __init__(
        ...
        self._recog = RecognitionNet(dset.get_n_classes(), dset.get_n_features()).to(device=self._device, dtype=dtype)
    ...
    def _param_init(self, dtype) -> None:
        ...
        # print("log_alpha: " + str(self._data["log_alpha"].dtype))
        # print("rho: " + str(self._data["rho"].dtype))
