...
parser$add_argument('--winsorize', type='double', help="percentage remaining after winsorizing")
args <- parser$parse_args()

sce <- readRDS(args$rds_in)

win = args$winsorize
winsorize(sce, exprs_values=args$assay, w_limits=c(win/2, 1-win/2))
